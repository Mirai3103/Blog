...
public class CustomExceptionHandler : IExceptionHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await HandleBaseException(httpContext, exception);
        return true;

    }

    private async Task HandleBaseException(HttpContext httpContext, Exception ex)
    {
        ...
        await httpContext.Response.WriteAsJsonAsync(new ProblemDetails()
        {
            ...
            Title = ((HttpStatusCode)baseException.StatusCode).ToString()
        });
    }
